...
/* FILTERS ROW */
.filters-row{padding:1rem 2rem;display:flex;gap:0.75rem;align-items:center;flex-wrap:wrap;max-width:1280px;margin:0 auto;}
...
/* GRID */
.grid-section{padding:1rem 2rem 3rem;max-width:1280px;margin:0 auto;}
